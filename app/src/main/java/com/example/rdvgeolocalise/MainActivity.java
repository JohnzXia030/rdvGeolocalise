...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        items.add("12345");
        items.add("555555");
        multiSpinner.setItems(items, "Select contact", new MultiSpinner.MultiSpinnerListener() {
            @Override
    ...
    /*public String getContactInfo() throws JSONException {
        ...
        int oldrid = -1;
        int contactId = -1;
        Cursor cursor = getContentResolver().query(ContactsContract.Data.CONTENT_URI,null, null, null, Data.RAW_CONTACT_ID);
        int numm=0;
